	...
	<jsp:include page="header.jsp"></jsp:include>
	 ...
	 <div class="container-fluid bg-light" style="margin-top: 150px;">
	   ...
	   <div class="container bg-light">
          ...
          <!-- get the value from scontent and show the searched result -->

			<%String name1=request.getParameter("scontent"); %>

			<% List<item> itemlist1=itemDBUtil.getSearchResult(name1);%>
