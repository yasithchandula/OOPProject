      ...
      <div class="container-fluid fixed-top" style="margin-top: 70px; z-index: -1;">
       ...
       <br>
		...
		<c:forEach var="itm" items="${itemlist}">
			...
			<div class="col">
                <div class="card">
                  <img src="https://live.staticflickr.com/65535/51203105920_dcf2c4d55c_b.jpg" class="card-img-top" alt="...">
                  <div class="card-body ">
                      <div class="d-flex">
                    ...
                    <form action="itemdet" method="post" id="itmdet">
                    	<button type="submit" form="itmdet" class="btn btn-success" name="detid" value="${itm.id}">Item Details</button>
                    </form>
                    <br>
