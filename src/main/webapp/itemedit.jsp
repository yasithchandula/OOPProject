...
<body>
  ...
  <c:forEach var="itm" items="${itemlist}">
	...
	<br>
		...
		<form action="updateitem" class="row g-3" method="post">
			<div class="forminsert">
			
			<div class="col-md-6">
				<label for="inputName" class="form-label">Item ID</label> 
				<input type="text" class="form-control" id="inputName" name="itemid" value="${itm.id }" readonly>
			</div>
			
			<div class="col-md-6">
				<label for="inputName" class="form-label">Item Name</label> 
				<input type="text" class="form-control" id="inputName" name="name" value="${itm.name }" required>
			</div>
			...
			<div class="col-md-6">
				<label for="inputsize" class="form-label">Size</label> <input
					type="text" name="size" class="form-control" id="inputsize" value="${itm.size }" required>
			</div>
			<div class="col-md-6">
				<label for="price" class="form-label">Price</label> 
				<input
					type="text" class="form-control" name="price" id="price"
					placeholder="enter price" value="${itm.price }" required>
			</div>
			<div class="col-md-8">
				<label for="description" class="form-label"> Description </label>
				<textarea class="form-control" name="description" rows="5" cols="5" id="description"
					required>${itm.description }</textarea>
			</div>
			<div class="col-6">
				<label for="available_qty" class="form-label">Available
					...
					placeholder="Apartment, studio, or floor" value="${itm.available_qty }" required>
			</div>


			<div class="col-8">
				<input type="submit" name="upadeitem" class="btn btn-primary">Update
